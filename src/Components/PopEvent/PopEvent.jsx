...
const PopEvent = ({ popular }) => {
    ...
    return (
        <div data-aos={`${dataAos} `} className='rounded-lg'>
            <div className="flex flex-col justify-between   rounded-lg border-2">
                <figure className='flex-1'><img src={img_url} className=' h-60 lg:h-96 w-full rounded-lg' alt="Movie" /></figure>
